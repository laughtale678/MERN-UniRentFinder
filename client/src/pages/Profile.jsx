...
export default function Profile() {
  ...
  const [showListingsErroe, setShowListingsError] = useState(false);
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      <h1 className="text-3xl font-semibold text-center my-7">Profille</h1>
      ...
      <p className="text-red-700 mt-5">
        {showListingsErroe ? "Error showing listings!" : ""}
      </p>
